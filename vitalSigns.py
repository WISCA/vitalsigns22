...
class vitalSigns(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            display_buffer, #size
            samp_rate/window_size/decimRate, #samp_rate
            "", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.fft_vxx_0 = fft.fft_vcc(window_size, True, [], False, 1)
        self.epy_block_0 = epy_block_0.blk(vecSize=window_size)
    ...
    def set_window_size(self, window_size):
        ...
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate/self.window_size/self.decimRate)
