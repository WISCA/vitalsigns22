...
class vitalSigns(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.window_size = window_size = 128
        self.tx_gain = tx_gain = 50
        self.samp_rate = samp_rate = 1e6
        self.rx_gain = rx_gain = 50
        self.freq = freq = 4e9
        self.decimRate = decimRate = 12
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            window_size, #size
            samp_rate/decimRate/window_size, #samp_rate
            "", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                1,
                samp_rate/window_size,
                300,
                100,
                window.WIN_HAMMING,
                6.76))
        self.fft_vxx_0 = fft.fft_vcc(window_size, True, window.blackmanharris(window_size), True, 1)
        self.epy_block_0 = epy_block_0.blk()
        self.dc_blocker_xx_0 = filter.dc_blocker_ff(32, True)
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, window_size)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, window_size-1)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_CONST_WAVE, 1, 1, 0, 0)
    ...
    def set_window_size(self, window_size):
        ...
        self.blocks_delay_0.set_dly(self.window_size-1)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate/self.window_size, 300, 100, window.WIN_HAMMING, 6.76))
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate/self.decimRate/self.window_size)
